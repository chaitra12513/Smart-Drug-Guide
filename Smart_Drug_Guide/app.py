...
# Home page - Redirect to doctor consultation

# Doctor consultation page - Show all doctors
...
# Book appointment page - Show selected doctor's details
...
def book_appointment():
    ...
    conn = get_db_connection()
    conn.execute("INSERT INTO appointments (doctor_id, patient_name, appointment_date) VALUES (?, ?, ?)",
                 (doctor_id, patient_name, appointment_date))
    conn.commit()
    conn.close()

    return render_template("confirmed_appointment.html", patient_name=patient_name, appointment_date=appointment_date)
